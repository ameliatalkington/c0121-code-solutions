...
function renderPokemon(pokemon) {
  ...
  document.body.appendChild($columnThird).setAttribute('class', 'column-third');
  $columnThird.appendChild($pokemonCard).setAttribute('class', 'pokemon-card');
  $pokemonCard.appendChild($image).setAttribute('src', pokemon.imageUrl);
  $pokemonCard.appendChild($pokemonCardText).setAttribute('class', 'pokemon-card-text');
